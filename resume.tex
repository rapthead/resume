...
\cventry{\mbox{Янв. 2013} – \mbox{Настоящее}}{Инженер-программист}{ВЦ СофтСервис}{Челябинск}{}{
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Разработка других сайтов: \httplink{psp.ru} (на данный момент обновленный вариант не запущен), \httplink{eko-logica.ru}, \httplink{domkafel.ru} и др.
    \end{itemize}
...
\cvitem{}{
    \cvdoubleitem{Perl}{отлично}{PHP}{хорошо}
    \cvdoubleitem{JavaScript}{средне}{Python}{средне}
    \cvitem{C++}{средне}
    %\begin{itemize}
...
\cvitem{}{
    ...
    \begin{itemize}
        \item HTML, CSS
        \item JQuery, AngularJs, Require JS
...
\cvitem{}{
    \begin{itemize}
        ...
        \item Понимание и опыт разработки, используя парадигму ООП
        \item Знание системы контроля версий git
    \end{itemize}
}
...
\cvlistdoubleitem{Компьютерное \textquotedblleftжелезо\textquotedblright}{Музыка}
\cvlistitem{Linux}
